...
use Easy\Eav\Models\Service\Migration\EntityTypeService;
use Easy\Eav\Models\Service\Migration\AttributeSetService;
use Easy\Eav\Models\Service\Migration\AttributeGroupService;
use Easy\Eav\Models\Service\Migration\AttributeService;
use Easy\Eav\Models\Service\Migration\EntityTableService;
...
class EavService
{
    ...
    public function populateEavData(array $data)
    {
        DB::transaction(function () use ($data) {
            ...
            if ($entityType = $this->entityTypeService->firstOrCreate($data['entity_type_code'])) {
